...
public class PermissionsActivity extends Activity {
    ...
    private void update() {
        ...
        PgyUpdateManager.register(PermissionsActivity.this,
                new UpdateManagerListener() {
                    @Override
                    public void onUpdateAvailable(final String result) {
                        // 将新版本信息封装到AppBean中
                        final com.pgyersdk.javabean.AppBean appBean = getAppBeanFromString(result);
                        new CommomDialog(PermissionsActivity.this, R.style.dialog, appBean.getReleaseNote(), new CommomDialog.OnCloseListener() {
                            @Override
