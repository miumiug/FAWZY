 ...
 * 需款计划搜索Activity
 **/
public class Xkjh_SearchActivity extends BaseActivity implements PullLoadMoreRecyclerView.PullLoadMoreListener {

    private static final String TAG = "Xkjh_SearchActivity";
...
//        mPullLoadMoreRecyclerView.setFooterViewText("loading");
    ...
    public void onLoadMore() {
        if (totalpage == curpage) {
            getLoadMore();
            showMiddleToast(Xkjh_SearchActivity.this, getResources().getString(R.string.all_data_hint));
        } else {
            curpage++;
            getData(search);
        }
    ...
    private void getData(String search) {
        String data = HttpManager.getSearchPAYPLANUrl(appid, search, AccountUtils.getpersonId(this), curpage, showcount);
        Log.e(TAG, "data=" + data);
        Rx2AndroidNetworking.post(GlobalConfig.HTTP_URL_SEARCH)
                ...
                .map(new Function<R_PAYPLAN.ResultBean, List<R_PAYPLAN.PAYPLAN>>() {
                    @Override
                    public List<R_PAYPLAN.PAYPLAN> apply(@NonNull R_PAYPLAN.ResultBean resultBean) throws Exception {
                ...
                .subscribe(new Consumer<List<R_PAYPLAN.PAYPLAN>>() {
                    @Override
                    public void accept(@NonNull List<R_PAYPLAN.PAYPLAN> payplan) throws Exception {
                        mPullLoadMoreRecyclerView.setRefreshing(false);
    ...
    private void initAdapter(final List<PAYPLAN> list) {
        xkjhAdapter = new XkjhAdapter(Xkjh_SearchActivity.this, R.layout.list_item_travel, list);
        ...
        xkjhAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(Xkjh_SearchActivity.this, XkplandetailActivity.class);
