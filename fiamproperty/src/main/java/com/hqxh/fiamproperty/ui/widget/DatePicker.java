...
import com.hqxh.fiamproperty.dateviews.decors.DPDecor;
import com.hqxh.fiamproperty.dateviews.languages.DPLManager;
import com.hqxh.fiamproperty.dateviews.themes.DPTManager;
import com.hqxh.fiamproperty.unit.MeasureUtil;
...
public class DatePicker extends LinearLayout {
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        rlTitle.setBackgroundColor(Color.parseColor("#4576bb"));
...
//        llWeek.setBackgroundColor(mTManager.colorTitleBG());
        llWeek.setBackgroundColor(Color.parseColor("#669dec"));
