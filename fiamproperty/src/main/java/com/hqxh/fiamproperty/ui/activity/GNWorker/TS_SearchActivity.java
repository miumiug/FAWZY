 ...
 * 出差申请搜索Activity
 **/
public class TS_SearchActivity extends BaseActivity implements PullLoadMoreRecyclerView.PullLoadMoreListener {
    ...
    private TaskSelectAdapter traveladapter;
...
//        mPullLoadMoreRecyclerView.setFooterViewText("loading");
    ...
    public void onLoadMore() {
        if (totalpage == curpage) {
            getLoadMore();
            showMiddleToast(TS_SearchActivity.this, getResources().getString(R.string.all_data_hint));
        } else {
            curpage++;
            getData(search);
        }
    ...
    private void getData(String search) {
        String data = HttpManager.getSearchTSUrl(appid, GlobalConfig.WORKORDER_NAME, search, AccountUtils.getpersonId(TS_SearchActivity.this), curpage, showcount);
        Log.e(TAG, "data=" + data);
    ...
    private void initAdapter(final List<Workorder> list) {
        traveladapter = new TaskSelectAdapter(TS_SearchActivity.this, R.layout.list_item_taskselect, list);
        ...
        traveladapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent = new Intent(TS_SearchActivity.this, RyrwdWorkorderActivity.class);
                intent.putExtra("workorder", (Serializable) traveladapter.getData().get(position));
