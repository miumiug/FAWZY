 ...
 * 出门管理搜索Activity
 **/
public class Cmgl_SearchActivity extends BaseActivity implements PullLoadMoreRecyclerView.PullLoadMoreListener {

    private static final String TAG = "Cmgl_SearchActivity";
...
//        mPullLoadMoreRecyclerView.setFooterViewText("loading");
    ...
    public void onLoadMore() {
        if (totalpage == curpage) {
            getLoadMore();
            showMiddleToast(Cmgl_SearchActivity.this, getResources().getString(R.string.all_data_hint));
        } else {
            curpage++;
            getData(search);
        }
    ...
    private void getData(String search) {
        String data = HttpManager.getSearchGRUrl(appid, GlobalConfig.GR_NAME, search, AccountUtils.getpersonId(Cmgl_SearchActivity.this), curpage, showcount);
        Rx2AndroidNetworking.post(GlobalConfig.HTTP_URL_SEARCH)
                ...
                .subscribe(new Consumer<List<GR>>() {
                    @Override
                    public void accept(@NonNull List<GR> workorder) throws Exception {
                        mPullLoadMoreRecyclerView.setRefreshing(false);
    ...
    private void initAdapter(final List<GR> list) {
        grAdapter = new GrAdapter(Cmgl_SearchActivity.this, R.layout.list_item_travel, list);
        ...
        grAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(Cmgl_SearchActivity.this, GrDetailsActivity.class);
