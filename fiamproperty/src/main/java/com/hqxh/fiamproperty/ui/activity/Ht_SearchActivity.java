 ...
 * 合同搜索Activity
 **/
public class Ht_SearchActivity extends BaseActivity implements PullLoadMoreRecyclerView.PullLoadMoreListener {
...
//        mPullLoadMoreRecyclerView.setFooterViewText("loading");
    ...
    public void onLoadMore() {
        if (totalpage == curpage) {
            getLoadMore();
            showMiddleToast(Ht_SearchActivity.this, getResources().getString(R.string.all_data_hint));
        } else {
            curpage++;
            getData(search);
        }
    ...
    private void getData(String search) {
        String data = HttpManager.getSearchPURCHVIEWUrl(appid, search, AccountUtils.getpersonId(this), curpage, showcount);
        Log.i(TAG, "data=" + data);
    ...
    private void initAdapter(final List<PURCHVIEW> list) {
        htAdapter = new HtAdapter(Ht_SearchActivity.this, R.layout.list_item_travel, list);
        ...
        htAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(Ht_SearchActivity.this, PurchviewActivity.class);
